...
//---------------- BEGIN MODULE SCOPE VARIABLES --------------
    ...
    //----------------- END MODULE SCOPE VARIABLES ---------------//------------------- BEGINUTILITY METHODS ------------------
    getRandRgb = function () {
        var i, rgb_list = [];
        for (i = 0; i < 3; i++) {
...
// Use this tohighlight avatar of user innav area
...
// add highlight to new_chatee avatarhere
        if (new_chatee) {
            $nav
    ...
    onListchange = function (event) {
        var
            ...
            $box;
        $nav.empty();
// if the user islogged out, do not render
        if (user.get_is_anon()) {
            return false;
        }
